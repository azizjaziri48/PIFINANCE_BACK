...
pricing_data, fundamental_data, news, tech_indicator, bott, openai1 = st.tabs(["Pricing Data", "Fundamental Data", "Sentiment Analysis", "Technical Analysis", "Bitcoin Trading Bot", "OpenAI ChatGPT"])
